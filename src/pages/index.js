  ...
  return (
    ...
    >
      ...
      <div className="flex p-1   md:px-10">
                      ...
                      <div className={`infos  dark:bg-[#112240] bg-white `}>
                        ...
                        <div className="h-[80%] flex flex-col justify-between dark:text-slate-300 text-slate-800">
                          ...
                          <div className="details w-[100%] px-2 flex justify-end gap-6 ">
                            <a target="_blank" href={pr.links.imageCredit}>
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
                            ...
                            <a target="_blank" href={pr.links.github}>
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
                            ...
                            <a target="_blank" href={pr.links.liveLink}>
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
            ...
            >
              ...
              <div className="w-[100%]">
                <form method="post" action="https://formspree.io/f/xeqbrwar">
                  <div className="flex md:flex-row flex-col justify-between mt-16 w-[100%]">
        ...
        <aside className="sidebar2 invisible lg:visible"></aside>
      </div>
      <div className="flex lg:hidden mt-[6rem]  gap-6 justify-center">
        <a target="_blank" href="https://github.com/sumitparida2002">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
        ...
        <a target="_blank" href="https://www.instagram.com/sumitparida/?hl=en">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
