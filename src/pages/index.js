...
const IndexPage = () => {
  return (
    <body className="py-2 px-10 bod bg-[#001C30] text-slate-400 tracking-wider ">
      <Layout>
        <main>
          <section className="lg:w-[70%] mx-auto mt-20">
            <p className="text-[#64CCC5]">Hi, my name is</p>
            <h1 className="text-7xl text-slate-200">Sumit Parida.</h1>
            <h1 className="text-6xl text">I'm a Full-Stack Web Developer.</h1>
          ...
          <section className="lg:w-[67%] mx-auto mt-20" id="about">
          ...
          <section id="projects" className="lg:w-[70%] mx-auto mt-20">
            <div className=" py-0 border-b-[1px] border-slate-500 w-[60%]  ">
            ...
            <div className="flex flex-row justify-between items-center">
              ...
              <div className="w-[43%] mt-8">
                ...
                <div className="w-[100%] bg-slate-950 p-4 mt-2 bg-[#112240] shadow-lg shadow-[#020c1bb3] ">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
